...
import com.rem.backend.repository.ExpenseDetailRepo;
import com.rem.backend.repository.ExpenseRepo;
import com.rem.backend.repository.ExpenseTypeRepo;
...
public class PdcPaymentService {
    ...
    public Map<String, Object> processPdc(long pdcId, String loggedInUser) {
        try {
            ...
            expense.setProjectId(pdcRecord.getProjectId() != null ? pdcRecord.getProjectId() : 0);
            expense.setUnitId(pdcRecord.getUnitId());
            expense.setExpenseTypeId(pdcRecord.getExpenseTypeId() != null ? pdcRecord.getExpenseTypeId() : 0);
