package com.rem.backend.vendormanagement.service;
...
import com.rem.backend.vendormanagement.repository.PdcRecordRepo;
...
public class VendorAccountService {
    ...
    public Map<String, Object> paybackCredit(VendorPayment request, String loggedInUser) {
        try {
            ...
            account.setTotalAmountPaid(account.getTotalAmountPaid() + request.getAmountPaid()); // ✅ FIX: Increase totalAmountPaid
            ...
            vendorPayment.setPaymentDocNo(request.getPaymentDocNo());
            vendorPayment.setPaymentDocDate(request.getPaymentDocDate());
    ...
    public Map<String, Object> updatePaybackCredit(Long paymentId, VendorPayment request, String loggedInUser) {
        try {
            ...
            vendorAccount.setTotalAmountPaid(vendorAccount.getTotalAmountPaid() + delta); // ✅ FIX: Adjust totalAmountPaid by delta
